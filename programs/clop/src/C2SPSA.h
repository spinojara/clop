...
class C2SPSA : public CSamplingPolicy, public CMaxEstimator, private CObserver {
      private: ///////////////////////////////////////////////////////////////////
	BobJenkinsRNG rnd;
	...
	static void Bound(double &x, double Max) {
      ...
      public: ////////////////////////////////////////////////////////////////////
	explicit C2SPSA(CResults &results, double a = 0.05, double A = 0.0, double c = 0.00001, double alpha = 1.0,
			double gamma = 1.0 / 6.0, double d = 0.501, double w = 0.1);
