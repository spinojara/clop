...
class CCrossEntropy : public CSamplingPolicy, public CMaxEstimator, private CObserver {
      private: ///////////////////////////////////////////////////////////////////
	...
	struct CIndividual {
		...
		bool operator<(const CIndividual &ind) const { return Victories > ind.Victories; }
	};
	...
	void OnReset();
      ...
      public: ////////////////////////////////////////////////////////////////////
	explicit CCrossEntropy(CResults &results, double Smoothing = 1.0, double DynamicSmoothing = 0.1,
			       bool fDistributionSmoothing = true, int PopulationSize = 100, int SelectionSize = 10,
			       int InitialBatchSize = 10, double BatchGrowth = 1.15, bool fDiagonal = true);
