...
CPFCubic::CPFCubic(int Dimensions)
    : CParametricFunction(Dimensions, ((Dimensions + 1) * (Dimensions + 2) * (Dimensions + 3)) / 6) {}
...
/////////////////////////////////////////////////////////////////////////////
bool CPFCubic::GetMax(const double *restrict vParam, double *restrict vx) const {
	if (Dimensions > 1)
...
// Compute monomials
/////////////////////////////////////////////////////////////////////////////
void CPFCubic::GetMonomials(const double *restrict vx, double *restrict vMonomial) const {
	int p = 0;
...
// Gradient
/////////////////////////////////////////////////////////////////////////////
void CPFCubic::GetGradient(const double *restrict vParam, const double *restrict vx, double *restrict vG) const {
	int p = 1;
