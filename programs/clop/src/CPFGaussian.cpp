...
CPFGaussian::CPFGaussian(int Dimensions, int Resolution)
    : CParametricFunction(Dimensions, Dimensions * Resolution), Resolution(Resolution), vCenter(Resolution),
...
/////////////////////////////////////////////////////////////////////////////
double CPFGaussian::GetValue(const double *vParam, const double *vx) const {
	double Result = 0;
...
// Compute monomials
/////////////////////////////////////////////////////////////////////////////
void CPFGaussian::GetMonomials(const double *restrict vx, double *restrict vMonomial) const {
	for (int i = Dimensions, p = Parameters; --i >= 0;)
		for (int j = Resolution; --j >= 0;)
...
// Gradient
/////////////////////////////////////////////////////////////////////////////
void CPFGaussian::GetGradient(const double *restrict vParam, const double *restrict vx, double *restrict vG) const {
	for (int i = Dimensions, p = Parameters; --i >= 0;) {
		vG[i] = 0.0;
		for (int j = Resolution; --j >= 0;) {
