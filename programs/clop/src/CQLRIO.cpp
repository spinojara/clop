...
// Recursive plot
/////////////////////////////////////////////////////////////////////////////
void CQLRIO::RecursivePlot(std::ostream &out, const CParametricFunction &pf, const double *vParam, std::vector<double> &v,
			   int Dimension) {
	if (--Dimension < 0) {
...
// Plot one regressor
/////////////////////////////////////////////////////////////////////////////
void CQLRIO::Plot(std::ostream &out, const CParametricFunction &pf, const double *vParam) {
