...
class CRSPSA : public CSamplingPolicy, public CMaxEstimator, private CObserver {
      private: ///////////////////////////////////////////////////////////////////
	//
	// Dimensions
	//
	...
	static void Bound(double &x, double Max) {
      ...
      public: ////////////////////////////////////////////////////////////////////
	explicit CRSPSA(CResults &results, int BatchSize = 100, double BatchGrowth = 1.15, double EtaPlus = 1.5,
			double EtaMinus = 0.4, double DeltaMin = 0.001, double DeltaMax = 0.5, double Delta0 = 0.5,
			double Rho = 2.0);
