...
CSPCOptimal::CSPCOptimal(const CPQuadratic1D &q1d)
    : Alpha(q1d.GetAlpha()), Beta(q1d.GetBeta()), Mu(q1d.GetMu()), s(std::sqrt(Solve() / Beta)), N(0), v(1) {}

/////////////////////////////////////////////////////////////////////////////
// Constructor from CPFQuadratic
/////////////////////////////////////////////////////////////////////////////
CSPCOptimal::CSPCOptimal(const double *vParam)
    : Alpha(vParam[0] - vParam[1] * vParam[1] / (4.0 * vParam[2])), Beta(vParam[2]), Mu(-vParam[1] / (2.0 * vParam[2])),
      s(std::sqrt(Solve() / Beta)), N(0), v(1) {}
