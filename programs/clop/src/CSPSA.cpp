...
// Constructor
/////////////////////////////////////////////////////////////////////////////
CSPSA::CSPSA(CResults &results, double a, double A, double c, double alpha, double gamma)
    : CObserver(results), Dimensions(results.GetDimensions()), a(a), A(A), c(c), alpha(alpha), gamma(gamma), vTheta(Dimensions),
      vDelta(Dimensions), vThetaPlusMinus(Dimensions) {
	OnReset();
}
