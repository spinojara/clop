...
// Constructor
/////////////////////////////////////////////////////////////////////////////
CCheckPointData::CCheckPointData(int TotalRepeats, int Samples, CCPListener *pcpl)
    : Samples(Samples), Repeats(0), vError(TotalRepeats), vDone(TotalRepeats, false), MaxSeed(-1), MaxError(0.0),
      TotalError(0.0), TotalMisses(0), pcpl(pcpl) {}
