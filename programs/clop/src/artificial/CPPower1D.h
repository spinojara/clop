...
class CPPower1D : public CArtificialProblem // p1d
{
	...
	const double Power;
      ...
      public: ////////////////////////////////////////////////////////////////////
	CPPower1D(double SquareMagnitude = 0.2, double Power = 20.0) : SquareMagnitude(SquareMagnitude), Power(Power) {}
	...
	void GetOptimalParameters(double v[]) const { v[0] = 2 * std::pow(2 * SquareMagnitude / Power, 1 / (Power - 2)) - 1; }
};
