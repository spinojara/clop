...
class CPSinExp : public CArtificialProblem {
	...
	const double Decay;
      ...
      public: ////////////////////////////////////////////////////////////////////
	CPSinExp(double Freq = 2.0, double Offset = 0.7, double Decay = -3.0) : Freq(Freq), Offset(Offset), Decay(Decay) {}
	...
	void GetOptimalParameters(double v[]) const { v[0] = std::atan(-Freq / Decay) / Freq - Offset; }
