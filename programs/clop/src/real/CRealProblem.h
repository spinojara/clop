...
class CRealProblem // rproblem
{
	...
	const CParameterCollection &paramcol;
      ...
      public: ////////////////////////////////////////////////////////////////////
	CRealProblem(const std::string &sScriptName, const std::list<std::string> &lsScriptParam,
		     const CParameterCollection &paramcol)
	    : sScriptName(sScriptName), lsScriptParam(lsScriptParam), paramcol(paramcol) {}
};
