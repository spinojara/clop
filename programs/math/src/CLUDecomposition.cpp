...
// Constructor
////////////////////////////////////////////////////////////////////////////
CLUDecomposition::CLUDecomposition(int nInit) : n(nInit) {
...
// Backsubstitution
////////////////////////////////////////////////////////////////////////////
void CLUDecomposition::Solve(const double *pdMatrix, const int *pIndex, const double *pb, double *px) const {
	for (int i = 0; i < n; i++) {
...
// SolveTranspose
////////////////////////////////////////////////////////////////////////////
void CLUDecomposition::SolveTranspose(const double *pdMatrix, const int *pIndex, const double *pb, double *px) const {
	for (int i = 0; i < n; i++) {
		double Sum = pb[i];
		for (int j = 0; j < i; j++)
