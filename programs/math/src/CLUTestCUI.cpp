...
// Command strings
////////////////////////////////////////////////////////////////////////////
const char *const CLUTestCUI::tszCommands[] = {"?", "size", "read", "write", "decompose", "solve", "solvet", 0};

//
// Command identifiers
//
enum { IDC_Help, IDC_Size, IDC_Read, IDC_Write, IDC_Decompose, IDC_Solve, IDC_SolveT };

////////////////////////////////////////////////////////////////////////////
// Local prompt
////////////////////////////////////////////////////////////////////////////
void CLUTestCUI::PrintLocalPrompt(std::ostream &out) { out << "LUTest"; }
...
////////////////////////////////////////////////////////////////////////////
int CLUTestCUI::ProcessCommand(const char *pszCommand, const char *pszParameters, std::istream &in, std::ostream &out) {
