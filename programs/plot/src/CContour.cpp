...
// Constructor
/////////////////////////////////////////////////////////////////////////////
CContour::CContour(const CSurface &surfInit) : surf(surfInit), xMin(-1), xMax(+1), yMin(-1), yMax(+1) { SetGridSize(20, 20); }
...
/////////////////////////////////////////////////////////////////////////////
void CContour::RefinePoint(double x0, double y0, double z0, double x1, double y1, double z1, double &x, double &y) const {
	for (int j = 4;;) {
		x = (z0 * x1 - z1 * x0) / (z0 - z1);
		y = (z0 * y1 - z1 * y0) / (z0 - z1);
...
/////////////////////////////////////////////////////////////////////////////
void CContour::PlotComponent(int BorderType, std::ostream &out, int fBorder, double dMax, double Scale) {
	//
