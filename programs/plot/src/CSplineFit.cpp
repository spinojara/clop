...
// Constructor
/////////////////////////////////////////////////////////////////////////////
CSplineFit::CSplineFit(const CDiscretizedLine &dlInit) : dl(dlInit), Points(0), vIndex(dl.Size()) {}
...
// PGF shortcut
/////////////////////////////////////////////////////////////////////////////
void CSplineFit::PGF(const CDiscretizedLine &dl, double DMax, std::ostream &out) {
	//
	// Split at angles
	//
	CSplineFit sfit(dl);
