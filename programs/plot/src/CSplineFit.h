...
class CSplineFit // sfit
{
	...
	void TikZ(int Precision = 2, bool fMoveTo = true, std::ostream &out = std::cout) const;

	static void PGF(const CDiscretizedLine &dl, double DMax, std::ostream &out = std::cout);
};
