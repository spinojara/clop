...
//
const char *const CConsoleUI::tszCommands[] = {"?", "x", "p", "child", "children", "echo", "!", "prompt", "myself", 0};

////////////////////////////////////////////////////////////////////////////
// Constructor
////////////////////////////////////////////////////////////////////////////
CConsoleUI::CConsoleUI(CConsoleUI *pcui, int openmodeInit) : openmode(openmodeInit) { SetParent(pcui); }
...
////////////////////////////////////////////////////////////////////////////
int CConsoleUI::ArrayLookup(const char *const psz, const char *const *const ppsz) {
	int Result = -1;
...
// Opening of a child
////////////////////////////////////////////////////////////////////////////
void CConsoleUI::OpenChild(int Parameter, std::istream &in, std::ostream &out) {
	...
	else if (listi.Value()->MainLoop(in, out) == PC_Close) {
		delete listi.Value();
		listi.Remove();
	}
}
...
////////////////////////////////////////////////////////////////////////////
int CConsoleUI::ProcessCommand(const char *pszCommand, const char *pszParameters, std::istream &in, std::ostream &out) {
	enum { IDC_Help, IDC_Close, IDC_Parent, IDC_Child, IDC_Children, IDC_Echo, IDC_System, IDC_Prompt, IDC_Myself };
...
////////////////////////////////////////////////////////////////////////////
void CConsoleUI::AddChild(CConsoleUI *pcui, std::istream &in, std::ostream &out) {
	if (pcui) {
		lpcuiChildren.Add();
...
////////////////////////////////////////////////////////////////////////////
void CConsoleUI::Parse(char *pszCommand, const char *&pszCommand2, const char *&pszParameters, const char *&pszInput,
...
////////////////////////////////////////////////////////////////////////////
int CConsoleUI::EnterParseAndProcess(std::istream &in, std::ostream &out, std::ostream *pofsLog) {
...
////////////////////////////////////////////////////////////////////////////
template <class T> void CConsoleUI::GetSet(T &x, const char *pszParameters, std::ostream &out) {
	if (*pszParameters) {
