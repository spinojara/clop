...
class CConsoleUI // cui
{
	...
	// private functions
	//
	void Parse(char *pszCommand, const char *&pszCommand2, const char *&pszParameters, const char *&pszInput,
	...
	int ArrayLookup(const char *const psz, const char *const *const ppsz);
	...
	//
	template <class T> static void GetSet(T &x, const char *psz, std::ostream &out);

      public: ///////////////////////////////////////////////////////////////////
	//
	// Constructor
	//
	explicit CConsoleUI(CConsoleUI *pcui = 0, int openmodeInit = OpenModal);
	...
	//
	int EnterParseAndProcess(std::istream &in, std::ostream &out, std::ostream *pofsLog = 0);
