...
class CTestCUI : public CConsoleUI // testcui
{
	...
	static const char *const tszCommands[];
      ...
      protected: ////////////////////////////////////////////////////////////////
	virtual int ProcessCommand(const char *pszCommand, const char *pszParameters, istream &in, ostream &out);

	virtual void PrintLocalPrompt(ostream &out) { out << "test"; };

      public: ///////////////////////////////////////////////////////////////////
	CTestCUI(CConsoleUI *pcuiParent = 0, int openmode = OpenModal) : CConsoleUI(pcuiParent, openmode) {
		cerr << "test CUI created !\n";
	};

	~CTestCUI(void) { cerr << "test CUI deleted !\n"; }
};

////////////////////////////////////////////////////////////////////////////
// List of commands
////////////////////////////////////////////////////////////////////////////
const char *const CTestCUI::tszCommands[] = {"?", "hello", "addchild", 0};

enum { IDC_Help, IDC_Hello, IDC_AddChild };

////////////////////////////////////////////////////////////////////////////
// Function to process commands
////////////////////////////////////////////////////////////////////////////
int CTestCUI::ProcessCommand(const char *pszCommand, const char *pszParameters, istream &in, ostream &out) {
