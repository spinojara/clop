...
// Constructor
////////////////////////////////////////////////////////////////////////////
template <class T> CConstListIterator<T>::CConstListIterator(const CList<T> &ltInit) {
	plt = &ltInit;
	pcellPrevious = 0;
...
////////////////////////////////////////////////////////////////////////////
template <class T> void CConstListIterator<T>::Reset(void) {
	pcellPrevious = 0;
...
////////////////////////////////////////////////////////////////////////////
template <class T> INLINE void CConstListIterator<T>::Increment(void) {
	ASSERT(!IsAtTheEnd());
...
////////////////////////////////////////////////////////////////////////////
template <class T> INLINE const T &CConstListIterator<T>::Value(void) const {
	ASSERT(!IsAtTheEnd());
