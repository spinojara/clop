...
static long MilliSeconds() {
	struct timeb tb;
	ftime(&tb);
	return long((tb.time - lTime0) * 1000 + tb.millitm);
}
...
// Default constructor
////////////////////////////////////////////////////////////////////////////
CClockTimer::CClockTimer() : lPrevious(MilliSeconds()) {}
