...
////////////////////////////////////////////////////////////////////////////
CJustifiedText::CJustifiedText(std::ostream &ostr, int LineLengthInit, int IndentInit)
    : LineLength(LineLengthInit), Indent(IndentInit) {
...
////////////////////////////////////////////////////////////////////////////
CJustifiedText &operator<<(CJustifiedText &jt, const std::string &s) { return jt << s.c_str(); }
