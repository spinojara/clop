...
class CListIterator // listi
{
	...
	CListCell<T> *pcellPrevious;
      ...
      public: ///////////////////////////////////////////////////////////////////
	explicit CListIterator(CList<T> &ltInit);
...
// Constructor
////////////////////////////////////////////////////////////////////////////
template <class T> CListIterator<T>::CListIterator(CList<T> &ltInit) {
	plt = &ltInit;
	pcellPrevious = 0;
...
////////////////////////////////////////////////////////////////////////////
template <class T> void CListIterator<T>::Reset() {
	pcellPrevious = 0;
...
////////////////////////////////////////////////////////////////////////////
template <class T> INLINE void CListIterator<T>::Increment() {
	ASSERT(!IsAtTheEnd());
...
////////////////////////////////////////////////////////////////////////////
template <class T> void CListIterator<T>::Insert() {
	if (!pcellPrevious) {
		plt->Add();
		pcellCurrent = plt->pcellFirst;
	}
...
////////////////////////////////////////////////////////////////////////////
template <class T> void CListIterator<T>::Remove() {
	ASSERT(!IsAtTheEnd());
...
////////////////////////////////////////////////////////////////////////////
template <class T> INLINE T &CListIterator<T>::Value() {
	ASSERT(!IsAtTheEnd());
