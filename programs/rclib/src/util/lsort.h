...
////////////////////////////////////////////////////////////////////////////
template <class T> CListCell<T> *CListSort<T>::ListMerge(CListCell<T> *pcell1, CListCell<T> *pcell2) {
	if (!pcell1)
		return pcell2;
...
////////////////////////////////////////////////////////////////////////////
template <class T> CListCell<T> *CListSort<T>::ListSortBis(CListCell<T> *pcell1, int Size) {
	if (Size < 2)
		return pcell1;
...
////////////////////////////////////////////////////////////////////////////
template <class T> CListSort<T>::CListSort(CList<T> &lt, int (*Comp)(const T &t1, const T &t2)) {
	Compare = Comp;
	int Size = lt.GetSize();
