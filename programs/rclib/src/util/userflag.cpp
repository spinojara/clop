...
// Default constructor
////////////////////////////////////////////////////////////////////////////
CUserFlag::CUserFlag() : Index(vState.size()) {
	vState.push_back(0);
	Activate();
}
...
////////////////////////////////////////////////////////////////////////////
void CUserFlag::DeActivate() { signal(SIGINT, (void(CDECL *)(int))SIG_IGN); }

////////////////////////////////////////////////////////////////////////////
// Function to reset SIGINT signals
////////////////////////////////////////////////////////////////////////////
void CUserFlag::Activate() { signal(SIGINT, InterruptSignalHandler); }

////////////////////////////////////////////////////////////////////////////
// Function to test the flag
////////////////////////////////////////////////////////////////////////////
int CUserFlag::IsSet() const { return vState[Index]; }

////////////////////////////////////////////////////////////////////////////
// Function to reset the flag
////////////////////////////////////////////////////////////////////////////
void CUserFlag::Reset() { vState[Index] = 0; }

////////////////////////////////////////////////////////////////////////////
// Function to set the flag
////////////////////////////////////////////////////////////////////////////
void CUserFlag::Set() { vState[Index] = 1; }
