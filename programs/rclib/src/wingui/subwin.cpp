...
////////////////////////////////////////////////////////////////////////////
void CSubWindow::GetTitleString(char *psz, int Size) const { GetWindowText(hwndThis, psz, Size); }
...
void CSubWindow::Create(LPCSTR lpszTitre) {
	...
	// Create new window
	//
	hwndThis = CreateWindow(szClassName, lpszTitre, fTitle ? dwStyleWithTitle : dwStyleWithoutTitle, 0, 0, 100, 100,
				hwndParent, 0, GetInstance(), 0);
	FATAL(!hwndThis);
...
////////////////////////////////////////////////////////////////////////////
void CSubWindow::Size(int x, int y, int cx, int cy) { SetWindowPos(hwndThis, 0, x, y, cx, cy, SWP_NOZORDER | SWP_NOACTIVATE); }
...
// Set status text
////////////////////////////////////////////////////////////////////////////
void CSubWindow::SetStatusText(const char *psz) { SetWindowText(hwndStatus, psz); }
...
// Message handler
////////////////////////////////////////////////////////////////////////////
LRESULT CALLBACK SubWindowMessage(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	long lThis;
...
////////////////////////////////////////////////////////////////////////////
LRESULT CSubWindow::MessageHandler(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch (Message) {
	case WM_SIZE: ////////////////////////////////////////////////////////////
		if (hwndStatus)
...
////////////////////////////////////////////////////////////////////////////
void CSubWindow::Initialize(HWND hwndParent, LPCSTR lpszTitre, HMENU hMenu, UINT idItem, DWORD dwStyle) {
	//
	...
	if (!GetClassInfo(GetInstance(), szClassName, &wc)) {
		wc.style = CS_BYTEALIGNCLIENT | CS_BYTEALIGNWINDOW | CS_PARENTDC | CS_DBLCLKS | CS_HREDRAW | CS_VREDRAW;
	...
	dwStyleWithTitle = dwStyleWithoutTitle | WS_CAPTION | WS_MINIMIZEBOX | WS_SYSMENU;
...
CSubWindow::CSubWindow()
    : hmenu(0), hwndStatus(0), fStatus(0), fState(0), fVisible(0), fTitle(1), hwndThis(0), hdcWindow(0), haccel(0) {}
