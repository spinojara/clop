...
//
const char *const CWindowCUI::tszCommands[] = {"?", "win", "xpos", "ypos", 0};

//
// Command identifiers
//
enum { IDC_Help, IDC_Win, IDC_XPos, IDC_YPos };

////////////////////////////////////////////////////////////////////////////
// Local prompt
////////////////////////////////////////////////////////////////////////////
void CWindowCUI::PrintLocalPrompt(ostream &out) { out << "Window"; }

////////////////////////////////////////////////////////////////////////////
// Function to process commands
////////////////////////////////////////////////////////////////////////////
int CWindowCUI::ProcessCommand(const char *pszCommand, const char *pszParameters, istream &in, ostream &out) {
