...
CXWindow::CXWindow(int SizeX, int SizeY) {
	...
	FATAL(!display);
	win = XCreateSimpleWindow(display, DefaultRootWindow(display), 0, 0, SizeX, SizeY,
				  0, // Border width
				  0, 0);
	{
		XGCValues gcv;
...
// Predicate
///////////////////////////////////////////////////////////////////////////
Bool CXWindow::Predicate(Display *display, XEvent *event, XPointer arg) { return event->xany.window = (Window)arg; }
